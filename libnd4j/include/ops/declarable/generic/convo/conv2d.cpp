...
CUSTOM_OP_IMPL(conv2d, 2, 1, false, 0, 9) {
    ...
    ConvolutionUtils<T>::conv2d(block, {input, weights, bias}, output, {kH,kW,sH,sW,pH,pW,dH,dW,isSameMode,isNCHW});
...
CUSTOM_OP_IMPL(conv2d_bp, 3, 2, false, 0, 9) {
    ...
    ConvolutionUtils<T>::conv2dBP(block, {input, weights, bias, gradO}, {gradI, gradW, gradB}, {kH,kW,sH,sW,pH,pW,dH,dW,isSameMode,isNCHW});
...
CUSTOM_OP_IMPL(conv2d_input_bp, 3, 1, false, 0, 9) {
    ...
    ConvolutionUtils<T>::conv2dBP(block, {&input, weights, nullptr, gradO}, {gradI, nullptr, nullptr}, {kH,kW,sH,sW,pH,pW,dH,dW,isSameMode,isNCHW});
